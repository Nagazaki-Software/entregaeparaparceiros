...
/// Functions to query LojaRecords (as a Stream and as a Future).
Future<int> queryLojaRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      LojaRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<LojaRecord>> queryLojaRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      LojaRecord.collection,
      LojaRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<LojaRecord>> queryLojaRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<int> queryCardapioRecordCount({
  ...
  int limit = -1,
    ...
    queryCollectionCount(
      CardapioRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );
...
/// Functions to query LanchesRecords (as a Stream and as a Future).
Future<int> queryLanchesRecordCount({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
...
Stream<List<LanchesRecord>> queryLanchesRecord({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
...
Future<List<LanchesRecord>> queryLanchesRecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
