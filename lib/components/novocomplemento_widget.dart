...
import 'novocomplemento_model.dart';
export 'novocomplemento_model.dart';

/// bottom sheet adicionar novo complemento
class NovocomplementoWidget extends StatefulWidget {
  const NovocomplementoWidget({super.key});
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              FFButtonWidget(
                onPressed: () async {
                  FFAppState().addToComplementos(ComplementoStruct(
                    nomeDoComplemento: _model.textController1.text,
                    valordocomplemento:
                        double.tryParse(_model.textController2.text),
                    descricaodocomplemento: _model.textController3.text,
                  ));
                  safeSetState(() {});
                  Navigator.pop(context);
                },
                text: 'Salvar Complemento',
